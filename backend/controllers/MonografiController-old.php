    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()))
        {
            ...
            */
            ...
            {
                Yii::$app->session->setFlash('error', 'Data Peraturan Gagal ditambahkan, periksa kembali ');
    ...
    public function actionTambahLampiran($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()))
        {
            ...
            if(!empty($dokumen_lampiran)){
                ...
                $model->dokumen_lampiran = FileHelper::sanitizeFilename($abstrak->dokumen_lampiran);
