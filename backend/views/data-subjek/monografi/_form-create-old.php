        ...
        <div class="tab-pane active" id="tab_1">
            <div class="box box-primary box-solid">
                ...
                <div class="box-body">
                    ...
                    <?= $form->field($model, 'tempat_terbit')->textInput(['placeholder' => 'tulis tempat terbit', 'maxlength' => true])->label('Tempat Terbit') ?>
                    ...
                    <?= $form->field($model, 'jumlah_eksemplar')->textInput(['placeholder' => 'Jumlah Buku', 'maxlength' => true])->label('Jumlah Eksemplar') ?>
