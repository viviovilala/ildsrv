...
<div class="box-body table-responsive no-padding">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            Catatan : menghapus data diatas hanya untuk kesalahan penginputan buku, bukan pengembalian buku, untuk pengembalian dimenu pengembalian buku, harap diingat.....!!!
        </div>
    </div>
