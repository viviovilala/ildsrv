 ...
 */
class Monografi extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return MonografiQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new MonografiQuery(get_called_class());
    }
    ...
    public function getJumlah($id)
    {
        ...
        return  Eksemplar::find()->where(['id_dokumen' => $id])->count();
    }
}
