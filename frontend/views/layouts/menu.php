...
/*
|--------------------------------------------------------------------------
| TEMPLATE MENU PARENT DENGAN LINK
|--------------------------------------------------------------------------
*/
...
$menuItems = [
    ...
    [
        ...
        'url' => '#',
        'options' => [
            'class' => 'dropdown mobile-menu-item',
        ],
        'activateItems' => true,
    ...
    [
        ...
        'template' =>
            $parentLinkTemplate('bi-journal-text'),

        'items' => array_map(
            static function (\common\models\DocumentType $t) {
    ...
    [
        ...
        'template' =>
            $parentTemplate('bi-info-circle'),

        'items' => [

            [
                'label' => 'Sekilas Sejarah',
                'url' => ['site/sekilas-sejarah'],
            ],

            [
                'label' => 'Dasar Hukum',
                'url' => ['site/dasar-hukum'],
            ],
            ...
            [
                ...
                'template' =>
                    '<a href="javascript:void(0)" class="mobile-menu-link mobile-menu-link--parent">'
                    . '<span class="mobile-menu-label">{label}</span>'
                    . '<i class="bi bi-chevron-down mobile-menu-chevron" aria-hidden="true"></i>'
                    . '</a>',
                ...
                'items' => [
                    ...
                    [
                        'label' => 'Biro/Bagian Hukum',
                        'url' => ['site/stoinstansi'],
                    ],
    ...
    [
        ...
        'template' =>
            $parentLinkTemplate('bi-link-45deg'),

        'items' => [

            [
                'label' => 'JDIHN Nasional',
    ...
    [
        ...
        'options' => [
            'class' =>
                'mobile-menu-item nav-search-item',
        ],

        'template' =>
            '<a href="{url}" class="mobile-menu-link nav-search-link" title="Cari dokumen" aria-label="Cari dokumen">'
    ...
    [
        ...
        'options' => [
            'class' =>
                'mobile-menu-item nav-chart-item',
        ],

        'template' =>
            '<a href="{url}" class="mobile-menu-link nav-chart-link" title="Statistik dokumen hukum" aria-label="Statistik dokumen hukum">'
...
|--------------------------------------------------------------------------
|
| Untuk guest, "Masuk" diarahkan ke aplikasi ADMIN/BACKEND.
| URL production:
|
| https://ildis.islab.web.id/backend/site/login
|
| Pada local:
|
| http://localhost:8080/backend/site/login
|
|--------------------------------------------------------------------------
*/
...
if (Yii::$app->user->isGuest) {
    ...
    $menuItems[] = [
        ...
        'template' =>
            '<a href="{url}" class="mobile-menu-link nav-login-link">'
    ...
    $menuItems[] = [
        ...
        'options' => [
            'class' =>
                'mobile-menu-item mobile-menu-auth',
        ],

        'template' =>
            $linkTemplate('bi-person-circle'),
    ...
    $menuItems[] = [
        ...
        'template' =>
            $linkTemplate('bi-box-arrow-right'),
