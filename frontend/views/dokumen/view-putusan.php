            ...
            <div class="col-lg-8">
                <div class="dokumen-view-card">
                    ...
                    <div class="row g-4 mb-5">
                        ...
                        <div class="col-sm-6">
                            <label class="dokumen-view-label">Amar Putusan</label>
                            <div class="dokumen-view-value">
                                <span class="dokumen-view-type-badge">
                        ...
                        <div class="col-sm-6">
                            <label class="dokumen-view-label">Lembaga Peradilan</label>
                            <div class="dokumen-view-value"><?= Html::encode($model->lembaga_peradilan ?: '-') ?></div>
                        </div>
                        <div class="col-sm-6">
                            <label class="dokumen-view-label">Tingkat Proses</label>
                            <div class="dokumen-view-value"><?= Html::encode($model->sub_klasifikasi ?: '-') ?></div>
                        </div>
                        <div class="col-sm-6">
                            <label class="dokumen-view-label">Tanggal Musyawarah</label>
                        ...
                        <div class="col-sm-6">
                            <label class="dokumen-view-label">Tanggal Dibacakan</label>
                            <div class="dokumen-view-value"><?= $model->tanggal_dibacakan ? \common\components\DateHelper::formatIndonesian($model->tanggal_dibacakan) : '-' ?></div>
                        </div>
                    </div>
                    ...
                    <div class="dokumen-view-sidebar-panel">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="dokumen-view-value mb-0"><?= Html::encode($model->tahun_terbit ?: '-') ?></p>
                            </div>
                            <div>
