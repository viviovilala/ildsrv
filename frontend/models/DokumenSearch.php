...
class DokumenSearch extends DokumenDataSubyek
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'dokumen_type_id' => $this->dokumen_type_id,

        ]);

        if(!empty($this->subyek))
        {
            //$query->
        }
